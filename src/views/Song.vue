      ...
      <div class="container mx-auto flex items-center">
        ...
        >
          <i
            class="fas"
            :class="{
              'fa-play': !playing || currentSong.original_name !== song.original_name,
              'fa-pause': playing && song.original_name === currentSong.original_name,
            }"
          ></i>
        </button>
...
export default {
  ...
  methods: {
    ...
    toggleSong() {
      if (this.currentSong && this.currentSong.original_name !== this.song.original_name) {
